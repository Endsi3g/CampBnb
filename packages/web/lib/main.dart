...
void main() async {
  // Utiliser des URLs propres (sans #)
  setPathUrlStrategy();
...
Future<void> _initializeApp() async {
  ...
  try {
    ...
    if (supabaseKey.isEmpty) {
      ...
      print('   Pour web, utilisez la clé anon key.');
  ...
  try {
    ...
    if (GeminiConfig.isValid) {
      ...
      GeminiMonitoring().logEvent(
        ...
        message: 'Application web démarrée avec succès',
      );
...
class CampbnbWebApp extends ConsumerWidget {
  const CampbnbWebApp({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp.router(
      ...
      // Thème culturel (adapté pour web)
