...
class CacheService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _logger.e(
        'Erreur lors de l\'initialisation du cache',
        error: e,
  ...
  List<Map<String, dynamic>>? getCachedListings({String? searchKey}) {
    ...
    try {
      ...
      _logger.e(
        'Erreur lors de la récupération des listings en cache',
        error: e,
      );
      return null;
    }
  ...
  Map<String, dynamic>? getCachedReservation(String reservationId) {
    ...
    try {
      ...
      _logger.e(
        'Erreur lors de la récupération de la réservation en cache',
        error: e,
      );
      return null;
    }
  ...
  Future<void> cacheUserData(String userId, Map<String, dynamic> data) async {
    ...
    try {
      ...
      _logger.e(
        'Erreur lors de la mise en cache des données utilisateur',
        error: e,
      );
    }
  }
  ...
  Map<String, dynamic>? getCachedUserData(String userId) {
    ...
    try {
      ...
      _logger.e(
        'Erreur lors de la récupération des données utilisateur en cache',
        error: e,
      );
      return null;
    }
  ...
  Future<void> removeFromCache(
    String key, {
    CacheType type = CacheType.listing,
  }) async {
    if (!_initialized) await initialize();
...
enum CacheType { listing, reservation, userData, searchResults }
